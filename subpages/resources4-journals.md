...
UCSB offers opportunities for undergraduate students to gain experience with scholarly publishing. Campus-based journals can be a great place to start exploring the publication process, whether you are preparing your first manuscript or interested in learning how research moves from submission through review and publication.
...
|---------|--------------|------|--------------|----------------|
| [**American Journal of Undergraduate Research**](https://ajuronline.org/) | Peer review by faculty  | Yes | Yes | No |
| [**Journal of Undergraduate Research & Scholarly Excellence**](https://www.jurpress.org/) | Peer review by faculty, graduate, and undergraduate referees | No | Yes | No |
| [**Journal of Young Investigators**](https://www.jyi.org/) | Double-blind | Yes | Yes | No |
| [**Reinvention: An International Journal of Undergraduate Research**](https://reinventionjournal.org/index.php/reinvention//) | Double-blind by academic referees | Yes | Yes | No |
{: .opportunities-table}
