...
This site is built with Jekyll and organized so that most updates can be made by editing Markdown, YAML, and image files rather than changing HTML.
...
* `about.md`: About page -- currently hidden
* `assignments.md`: Assignments page -- currently hidden
* `schedule.md`: Schedule landing page -- currently hidden
...
* `_assignments/`: assignment content if used later 
...
* To post new homepage annoucement to the Update box: create a file in `_announcements/`
...
2. Open `_config.yml`.
   ...
   2. Update `baseurl` field according to your reporsitory's name (e.g., `/soar2`).
